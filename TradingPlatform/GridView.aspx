<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Root.master" CodeBehind="GridView.aspx.cs" Inherits="TradingPlatform.GridViewModule" Title="GridView" %>
            ...
            <dx:GridViewDataComboBoxColumn FieldName="Priority" CellStyle-HorizontalAlign="Center" Width="90">
                ...
                <PropertiesComboBox ShowImageInEditBox="true">
                    ...
                    <Items>
                        ...
                        <dx:ListEditItem Text="edza" Value="2" ImageUrl="Content/Images/priority2.svg" />
